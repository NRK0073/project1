    ...
    <div id="main">
        ...
        <section id="top" class="one dark cover">
            <div class="container">
                ...
                <header>
                    <h2 class="alt"><strong>Payroll Management System</strong> <br /> site designed by neeraj khan.</h2>
        ...
        <section id="portfolio" class="two">
            <div class="container">
                ...
                <p>add,delete or update any number of employees.</p>
...
?>
    ...
    <div id="footer">
        ...
        <!-- Copyright -->
        <ul class="copyright">
        <li>&copy; Payroll Management System. All rights reserved.</li>
        <li>Design: NRK/neerajkhan</a></li>
        </ul>
