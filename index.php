...
<body>
    ...
    <div class="login">
        ...
        <form name="loginform" onsubmit="return validateForm();" action="payroll.php" method="post">
            ...
            <button type="submit" value="Login" class="btn btn-primary btn-block btn-large">Enter</button>
        </form>
    </div>
